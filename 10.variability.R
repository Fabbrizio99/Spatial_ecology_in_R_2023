#the higher the variability, the higher the number of species
...
nir <- sent [[1]]
plot(nir) #green part is vegetation, orange is bare soil, 


#moving window--> it calculates the standard deviations of the central pixel from a nine selection(3x3) and it is moving until it measures the whole picture, it puts the value in the
#central pixel each time 
#focal, we use the band nir, matrix is describing the dimension of the moving window that here is a 3x3, we describe the function we want to use
